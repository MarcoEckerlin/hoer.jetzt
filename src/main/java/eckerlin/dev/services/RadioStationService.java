...
public class RadioStationService {
    ...
    /**
     * Alle Sender einschliesslich AI-Radio.
     *
     * <p>Nur fuer Aufrufer, die die Freigabe selbst pruefen. Wer eine Liste an
     * Nutzer ausgibt, nimmt {@link #findAllForConfiguredBot(boolean)}.
     */
    public List<RadioStation> findAllForConfiguredBot() {
        return findAllForConfiguredBot(true);
    }
     ...
     */
    public List<RadioStation> findAllForConfiguredBot(boolean mitSmartRadio) {

...
public class GuildEntitlementService {
     ...
     *
     * <p>Die Zaehlung laeuft ueber ein {@code INSERT ... ON CONFLICT ... DO UPDATE},
    ...
    public void set(String guildId, GuildFeature feature, boolean enabled, int dailyLimit, String note, String actorUserId) throws SQLException {
        ...
        String sql = """
                ...
                VALUES (?,?,?,?,?,?,?)
                ON CONFLICT (bot_id, guild_id, feature) DO UPDATE SET
    ...
    private int incrementUsage(String guildId, GuildFeature feature) {
        String sql = """
                ...
                VALUES (?,?,?,?,1)
                ON CONFLICT (bot_id, guild_id, feature, usage_day) DO UPDATE SET
                    used_count = guild_feature_usage.used_count + 1
                """;
        String read = """

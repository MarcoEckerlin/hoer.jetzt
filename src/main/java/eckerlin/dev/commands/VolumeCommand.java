...
public class VolumeCommand implements SlashCommand {
    ...
    public SlashCommandData getCommandData() {
        return Commands.slash("volume", "Setzt die Lautstaerke")
                .addOptions(new OptionData(OptionType.INTEGER, "wert", "0 bis 150 (ueber 100 kann verzerren)", true)
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        String hint = newVolume > AudioService.CLEAN_VOLUME_LIMIT
                ? " Ueber " + AudioService.CLEAN_VOLUME_LIMIT + "% wird das Signal digital verstaerkt und kann hoerbar verzerren."
                : "";
        CommandHelper.replySuccess(event, "Audio", "Lautstaerke auf " + newVolume + "% gesetzt." + hint, false);
    }
}

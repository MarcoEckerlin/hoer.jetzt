...
public class RadiosCommand implements SlashCommand {
    ...
    public SlashCommandData getCommandData() {
        return Commands.slash("radios", "Listet die verfuegbaren Radiosender")
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        if (stations.isEmpty()) {
            CommandHelper.replyError(event, "Radio", "Aktuell sind keine Radiosender verfuegbar.", true);
            return;
        }

...
## Dieses Release ausrollen — v2026.08.15.1

Neu darin: **Nachrichten-Vorlagen** — ein voller Embed-Editor für Willkommen,
...
```bash
bash /tmp/hochladen.sh /tmp/hoerjetzt-v2026.08.15.1.bundle
```

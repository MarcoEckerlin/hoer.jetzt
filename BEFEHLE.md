...
## Dieses Release ausrollen — v2026.08.13.21

Neu darin: die **Knotenwache** — neue oder geänderte Audio-Knoten kommen ohne
Neustart des Bots dazu; der Cipher-Dienst `yt-cipher` (gegen
`must find sig function`, das alle Titel betraf); YouTube-Anmeldung auch auf
reinen Knoten-Hosts; und das Suchfeld im Webplayer wird nicht mehr alle fünf
Sekunden geleert.

**1 — Bundle nach GitHub** (auf dem Rechner mit Schreibzugang):

```bash
bash /tmp/hochladen.sh /tmp/hoerjetzt-v2026.08.13.21.bundle
```

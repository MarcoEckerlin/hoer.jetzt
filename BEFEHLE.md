...
## Dieses Release ausrollen — v2026.08.13.23

Neu darin: die **Sitzungsnachricht** in Discord ist neu geordnet — vier Ebenen
statt zweier Symbolspalten, Cover als Vorschaubild, vier Knöpfe statt fünf;
...
```bash
bash /tmp/hochladen.sh /tmp/hoerjetzt-v2026.08.13.23.bundle
```

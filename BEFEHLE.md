...
## Dieses Release ausrollen — v2026.08.13.20

Neu darin: der Cipher-Dienst `yt-cipher` (gegen `must find sig function`, das
alle Titel betraf), YouTube-Anmeldung auch auf reinen Knoten-Hosts, und das
Suchfeld im Webplayer wird nicht mehr alle fünf Sekunden geleert.

**1 — Bundle nach GitHub** (auf dem Rechner mit Schreibzugang):

```bash
bash /tmp/hochladen.sh /tmp/hoerjetzt-v2026.08.13.20.bundle
```

...
Meist YouTube, und meist einer von zwei Gründen.
...
Metal und Rap ebenso. Der Knoten fragt seit `v2026.08.13.13` zuerst
`TVHTML5EMBEDDED`, der viele davon auch ohne Anmeldung ausliefert. Bleibt es
dabei, hilft nur ein angemeldetes Konto:
